      ...
      <Container className="py-16 sm:py-20 lg:py-28">
        <div className="grid gap-10 lg:grid-cols-[0.88fr_1.12fr] lg:gap-14">
          <Reveal>
            <SectionHeading
              eyebrow="Waitlist"
              title="Controlled access does not need a loud form."
              description="The waitlist exists for future releases, collector interest, and clients who want to enter the house before broader announcements."
            />
